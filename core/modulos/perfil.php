...
?>
    ...
    <head>
		...
		?>
            ...
            <link rel="stylesheet" href="assets/css/bootstrap-editable.min.css" /> </head>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="clearfix">
                                <div class="pull-left alert alert-success no-margin">
                                    <button type="button" class="close" data-dismiss="alert"> <i class="ace-icon fa fa-times"></i> </button> <i class="ace-icon fa fa-umbrella bigger-120 blue"></i> Haga clic en algún campo para editarlo ... </div>
                            </div>
                            <!-- <div class="clearfix">
									<div>
                                    ...
                                    <div class="col-xs-12 col-sm-3 center">
                                        <div> <span class="profile-picture">
                                            ...
                                            <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                                <div class="inline position-relative"> <span class="user-title-label"></span> &nbsp; <span class="white"><?php echo $row['nombre']; ?></span> </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-contact-info">
                                            <div class="profile-contact-links align-left">
                                                <a href="#" class="btn btn-link"> <i class="ace-icon fa fa-plus-circle bigger-120 green"></i> Agregar a un grupo </a>
                                                <a href="#" class="btn btn-link"> <i class="ace-icon fa fa-envelope bigger-120 pink"></i> Enviar un correo electrónico </a>
                                                <a href="#" class="btn btn-link"> <i class="ace-icon fa fa-globe bigger-125 blue"></i> Sitio web </a>
                                                <div> </div>
                                            </div>
                                            <div class="space-6"></div>
                                    ...
                                    <div class="col-xs-12 col-sm-9">
                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value"> <span class="editable" id="cedula" name="cedula"><?php echo $row['cedula']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Nombre </div>
                                                <div class="profile-info-value"> <span class="editable" id="nombre" name="nombre"><?php echo $row['nombre']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Apellido </div>
                                                <div class="profile-info-value"> <span class="editable" id="apellido"><?php echo $row['apellido']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-name"> Dirección </div>
                                            <div class="profile-info-value"> <i class="fa fa-map-marker light-orange bigger-110"></i> <span class="editable" id="estado" name="estado"><?php echo $row['estado']; ?></span> <span class="editable" id="direccion" name="direccion"><?php echo $row['direccion']; ?></span> </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Edad </div>
                                                <div class="profile-info-value"> <span class="editable" id="edad" name="edad"><?php echo $row['edad']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Fecha de nacimiento </div>
                                                <div class="profile-info-value"> <span class="editable" id="nacimiento" name="nacimiento"><?php echo $row['nacimiento']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Contratado el </div>
                                                <div class="profile-info-value"> <span class="editable" id="f_contratado" name="f_contratado"><?php echo $row['f_contratado'];?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Teléfono </div>
                                                <div class="profile-info-value"> <span class="editable" id="telefono" name="telefono"><?php echo $row['telefono']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Correo </div>
                                                <div class="profile-info-value"> <span class="editable" id="correo" name="correo"><?php echo $row['correo']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Genero </div>
                                                <div class="profile-info-value"> <span class="editable" id="genero" name="genero"><?php echo $row['genero']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Condición </div>
                                                <div class="profile-info-value"> <span class="editable" id="condicion" name="condicion"><?php echo $row['condicion']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Formación </div>
                                                <div class="profile-info-value"> <span class="editable" id="formacion" name="formacion"><?php echo $row['formacion']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Banco de preferencia </div>
                                                <div class="profile-info-value"> <span class="editable" id="banco" name="banco"><?php echo $row['banco']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Numero de cuenta </div>
                                                <div class="profile-info-value"> <span class="editable" id="nr_cuenta" name="nr_cuenta"><?php echo $row['nr_cuenta']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Materia principal impartida </div>
                                                <div class="profile-info-value"> <span class="editable" id="materia1" name="materia1"><?php echo $row['materia1']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Materia secundaria </div>
                                                <div class="profile-info-value"> <span class="editable" id="materia2" name="materia2"><?php echo $row['materia2']; ?></span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                                <div class="profile-info-name"> Notas sobre el profesor </div>
                                                <div class="profile-info-value"> <span class="editable" id="about">Editar con WYSIWYG</span> </div>
                                            </div>
                                            <div class="profile-info-row">
                                        ...
                                        <div class="center">
                                            <a href="perfil.php?id=<?PHP echo $row['ID']?>&queja=si">
                                                <button type="button" class="btn btn-sm btn-warning btn-white btn-round"> <i class="ace-icon fa fa-flag bigger-150 middle orange2"></i> <span class="bigger-110">Agregar queja</span> <i class="icon-on-right ace-icon fa fa-arrow-right"></i> </button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
